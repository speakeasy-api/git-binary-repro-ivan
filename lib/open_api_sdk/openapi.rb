...
module OpenApiSDK
  ...
  class Openapi
    ...
    attr_accessor :pet, :store, :user


    def initialize(client: nil, retry_config: nil, timeout_ms: nil, petstore_auth: nil, security_source: nil, server_idx: nil, server_url: nil, url_params: nil)
    ...
    def init_sdks
      @pet = Pet.new(@sdk_configuration)
      @store = Store.new(@sdk_configuration)
