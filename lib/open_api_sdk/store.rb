...
module OpenApiSDK
  ...
  class Store
    ...
    def get_inventory(security:, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Hash.new(Symbol, ::Integer))
          response = Models::Operations::GetInventoryResponse.new(
    ...
    def place_order(request:, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/xml')
          ...
          return Models::Operations::PlaceOrderResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            body: obj
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::Order)
          response = Models::Operations::PlaceOrderResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            order: obj
    ...
    def get_order_by_id(order_id:, timeout_ms: nil)
      # get_order_by_id - Find purchase order by ID
      # For valid response try integer IDs with value >= 1 and <= 10. Other values will generated exceptions
      request = Models::Operations::GetOrderByIdRequest.new(
        order_id: order_id
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::GetOrderByIdRequest,
        base_url,
        '/store/order/{orderId}',
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/xml')
          ...
          return Models::Operations::GetOrderByIdResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            body: obj
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::Order)
          response = Models::Operations::GetOrderByIdResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            order: obj
    ...
    def delete_order(order_id:, timeout_ms: nil)
      # delete_order - Delete purchase order by ID
      # For valid response try integer IDs with positive integer value. Negative or non-integer values will generate API errors
      request = Models::Operations::DeleteOrderRequest.new(
        order_id: order_id
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::DeleteOrderRequest,
        base_url,
        '/store/order/{orderId}',
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ['2XX'])
        ...
        return Models::Operations::DeleteOrderResponse.new(
          status_code: http_response.status,
          content_type: content_type,
          raw_response: http_response
        )
